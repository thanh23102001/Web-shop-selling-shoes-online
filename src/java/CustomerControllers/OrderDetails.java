...
public class OrderDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("userLogin") == null) {
            ...
            ArrayList<Models.OrderDetails> orderDetails = ODdao.getOrderDetails(orderID);
            request.setAttribute("stt", stt);
            request.setAttribute("ListOrderDetails", orderDetails);
            request.getRequestDispatcher("/Customer-Screen/OrderDetail.jsp").forward(request, response);
        }
