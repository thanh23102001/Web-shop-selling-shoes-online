 ...
 * @author vietd
 */
@WebServlet(name = "EmployeeUpdateProfile", urlPatterns = {"/EmployeeUpdateProfile"})
public class EmployeeUpdateProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            new AccountDAO().updateAccount(email, pass, username);
