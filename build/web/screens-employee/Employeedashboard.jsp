                    ...
                    <!--basic load - account-->
                                    ...
                                    <div class="card-body py-4 px-5">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3 name" style="margin-left: 10px">
                                                <a href="EmployeeShowProfile" class="font-bold">${accountName}</a>
                                                <br>
                        ...
                        <div class="row">
                            <div class="col-4 pr-4">
                                <div class="card">
                                    <div class="card-header row">
                                        <h4 class="col-9">Top Products</h4>
                            ...
                            <div class="col-4 pr-4">
                                <div class="card">
                                    <div class="card-header row">
                                        <h4 class="col-9">Top Rated Products</h4>
                            ...
                            <div class="col-4">
                                <div class="card">
                                    <div class="card-header row">
                                        <h4 class="col-9">Top Customers</h4>
                                        <h6 class="col-3">Orders</h6>
                                    </div>
                                    <div class="card-body row py-3">
                                        <c:set var="count" value="0" scope="page" />
